...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"dinero", "masternodelist", &masternodelist, true, true, false},
        {"dinero", "mnbudget", &mnbudget, true, true, false},
        {"dinero", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dinerod, or the -server option to dinero-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
