...
git clone https://github.com/dinero-crypto/dinero.git
cd dinero
...
```bash
    ...
    From https://github.com/dinero-crypto/dinero
...
[dinero/gitian.sigs](https://github.com/dinero-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
