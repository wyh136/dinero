...
In order to support loading of multiple wallets in dinero-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dinero.cpp.
...
Changes to dinero.cpp
----------------------
dinero.cpp is the entry point into dinero-qt, and as such, will require some minor modifications to provide hooks for
